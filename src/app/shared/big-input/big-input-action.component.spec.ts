...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<calculator-big-input-action></calculator-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<calculator-big-input-action [disabled]="true"></calculator-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<calculator-big-input-action fontSet="fas" fontIcon="fa-trash"></calculator-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<calculator-big-input-action label="delete"></calculator-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<calculator-big-input-action (action)="actionHandler()"></calculator-big-input-action>`;
    fixture = createHostComponent(template);
